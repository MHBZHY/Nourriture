...
module.exports.router = function (app) {
	...
	app.post('/menu_name', urlEncodedParser, function (req, res) {
	...
	app.post('/shop_login', urlEncodedParser, function (req, res) {
		shop.authByName(req.body.name, req.body.password, req.models.shop, res, function (id) {
	...
	app.post('/menu_id', urlEncodedParser, function (req, res) {
		menu.getInfoById(req.body.id, req.models.menu, res, function (rows) {
			res.send(rows);
		});
	});
